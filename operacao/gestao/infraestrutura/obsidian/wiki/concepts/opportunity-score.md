---
type: concept
title: Opportunity Score — Metodologia de Qualificação de Leads
aliases: [score, pontuacao de lead, qualificacao]
date_created: 2026-06-29
date_updated: 2026-06-29
source_count: 1
tags: [prospeccao, qualificacao, metodologia]
status: stable
---

# Opportunity Score — Metodologia de Qualificação de Leads

Score de 0 a 100 que define a ordem de quem abordar primeiro no funil de aquisição da Real Vision.

## Composição (4 sub-scores de 25 pontos cada)
...
| Score | Ação |
|---|---|
| 80–100 | Abordar imediatamente |
| 60–79 | Abordar no ciclo padrão |
| 40–59 | Pipeline futuro |
| < 40 | Arquivar |
