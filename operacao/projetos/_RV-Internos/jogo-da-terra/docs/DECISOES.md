...
| 05/07/2026 | **Visão e propósito do projeto registrada:** o jogo é "tecnologia de despertar coletivo", não um jogo comum — ver [[VISAO-PROPOSITO]]. Regras de ouro: cada cena precisa passar no teste "por que uma pessoa pararia 5 min pra jogar isso?"; NPCs/personagens históricos perguntam, nunca ensinam; zero jargão (alquimia/hermetismo) na tela; cada viagem no tempo é um espelho explícito do hoje | Felipe (sessão de amadurecimento, registrada por Hermes Agent) |
| 05/07/2026 | **Roteiro do Capítulo 1 reescrito (v2)** conforme a visão acima — mudanças principais: prólogo "HOJE" (o desconforto do piloto automático) antes de qualquer viagem no tempo; Hipátia reduzida a 2 perguntas que devolvem, nunca ensinam; clímax novo = "o que resta de você quando todas as telas se apagam?" (jogador vs. IA sem alma); HUD sem nomes de estágio, só o símbolo 🔥; ficha do personagem com os três centros (cabeça/coração/ventre) já desregulados desde o início. v1 preservada em [[ROTEIRO-CAP1-v1]] (nunca apagar); v2 é a vigente em [[ROTEIRO-CAP1]] | Felipe ("pode reescrever sim") |
| 05/07/2026 | **Protótipo atualizado para o roteiro v2** e testado ponta a ponta no preview (prólogo → viagem → chegada → rodinha "A mão que já sabe" → Hipátia com as 2 perguntas → clímax → brasa acesa no HUD, sem jargão) | Sessão de implementação |
